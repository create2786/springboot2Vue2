<template>
  <div>
    ...
    <el-table :data="tableData" border header-row-class-name="headerBg" stripe
      ...
      <el-table-column label="编号" prop="id" sortable width="70"></el-table-column>
      <el-table-column align="center" label="商品图片" width="200">
        <template slot-scope="scope"><img :src="scope.row.goodsImg" style="height: 100px"></template>
      </el-table-column>
      <el-table-column label="商品名称" prop="username"></el-table-column>
      <el-table-column label="商品价格" prop="goodsPrice"></el-table-column>
      <el-table-column label="货号" prop="goodsOrder"></el-table-column>
      <el-table-column label="销量" prop="goodsSale"></el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="商品信息" width="33.3%">
      <el-form label-width="100px">
        ...
        <el-form-item label="货号">
          <el-input v-model="form.goodsOrder" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="销量">
          <el-input v-model="form.goodsSale" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
